  ...
  return (
    <>
      ...
      <section
        ...
        } w-72 ps-5 h-screen z-20 absolute top-0 rounded-e-3xl text-white duration-300 transition-all overflow-y-auto overflow-x-hidden ${
      ...
      >
        ...
        <button
          ...
          className={`bg-[#38A7B6] w-36 h-12 rounded-3xl shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer font-medium mt-3`}
        >
          Create Project
        </button>
      </section>
